...
/**
 * Grants ward (with a configurable cost) to a single target (e.g., an Aura granting
 * ward to the enchanted creature). Unlike GrantWardToGroup, this targets a single
 * StaticTarget (typically AttachedCreature for Auras or Equipment).
 *
 * Both the WARD keyword display and the enforcement trigger are generated by the engine.
 */
